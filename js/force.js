...
//need to wrap these 2 functions in a closure.  mult is bleeding over from app.js
...
var svg = d3.select("#force-map").append("svg")
    .attr("width", width)
    .attr("height", height);
...
d3.json("data/colors.json", function(color) {
  ...
  node.enter().append("circle")
      ...
      .attr("class", function(d) { return d.state + ' ' + color[d.state] })
